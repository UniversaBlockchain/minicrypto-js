...
describe('RSA', function() {
  ...
  describe('key creation', function() {
    ...
    it.skip('should pack with password', function() {
      this.timeout(8000);
    ...
    it.skip('should pack with password and iterations', function() {
      this.timeout(8000);
    ...
    it.skip('should read v2 keys', function() {
    ...
    it.skip('should read/write key from/to BOSS format', function() {
      const base64Encoded = seedKeys[2];
      const key = new PrivateKey('BOSS', decode64(base64Encoded));
    ...
    it.skip('should check equality of keys', function() {
  ...
  describe('Public key', function() {
    it.skip('should return bit strength', function(done) {
      const options = {
        bits: 2048,
        e: 0x10001
      };
    ...
    it.skip('should return encryption max length', function() {
      var oaepOpts = {
        seed: seedOAEP.seed,
        pssHash: new SHA(1),
        mgf1Hash: new SHA(1)
    ...
    it.skip('should return encryption max length with string opts', function() {
      var oaepOpts = {
        seed: seedOAEP.seed,
        pssHash: 'sha1',
        mgf1Hash: 'SHA1'
    ...
    it.skip('should verify address', function() {
    ...
    it.skip('should encrypt data with OAEP and MGF1', function() {
    ...
    it.skip('should encrypt data with OAEP and MGF1 with string opts', function() {
      // To make test repeatable
      var oaepOpts = {
        seed: seedOAEP.seed,
        pssHash: 'SHA1',
    ...
    it.skip('should calculate fingerprint', function() {
    ...
    it.skip('should verify message PSS signature', function() {
    ...
    it.skip('should verify message PSS signature with string opts', function() {
      var publicKey = new PublicKey('EXPONENTS', seedPSS);
      var pssOpts = {
        salt: seedPSS.salt,
        pssHash: 'SHA1',
    ...
    it.skip('should verify real message', function() {
    ...
    it.skip('should calculate short address', function() {
    ...
    describe('signature with custom salt', function() {
      ...
      it.skip('should use maximum salt length for signatures by default (490)', function() {
      ...
      it.skip('signature check with default params expect work for signature created with default params', function() {
      ...
      it.skip('should pss sign with sha3', function() {
      ...
      it.skip('should pss 384', function(){
  ...
  describe('Private key', function() {
    it.skip('should read from BOSS format', function() {
    ...
    it.skip('should restore key from exponents (e, p, q)', function() {
      var privateKey = new PrivateKey('EXPONENTS', {
        e: seedOAEP.e,
        p: seedOAEP.p,
        q: seedOAEP.q
    ...
    it.skip('should decrypt data with OAEP and MGF1', function() {
      // To make test repeatable
